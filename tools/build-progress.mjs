...
const ajv = new Ajv({ strict: true, discriminator: true, loopRequired: 3, loopEnum: 3, allErrors: false, messages: false, code: { source: true, esm: true, optimize: 2 }, inlineRefs: false });
