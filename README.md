...
Реализована статическая React/TypeScript PWA: полный курс, локальный прогресс, резервные копии, офлайн-пакет и согласованное обновление. Инженерная часть дорожной карты D0–D12 реализована. Внешние проверки продолжаются: татарская и предметная рецензии, пилот и реальные устройства/ассистивные технологии ожидают внешней приёмки. Права на материалы подтверждены владельцем.
...
Push в защищённую main запускает полный набор технических проверок, Pages и внешний smoke. По решению владельца от 13.09.2026 ожидающие внешние рецензии не блокируют Actions; их фактический статус сохраняется в release bundle. Права и достоверность имеющихся отчётов проверяются. Push и выпуск выполняет владелец. Публичный адрес — [halsab.github.io/isketatar](https://halsab.github.io/isketatar/), обратная связь — [Issues](https://github.com/halsab/isketatar/issues). В публичный issue не прикладывать файл личного прогресса.
