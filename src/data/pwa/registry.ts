...
export interface Registry {
  ...
  checked_at?: number; offline_epoch?: number;
}
...
function checked(value: Registry | undefined): Registry {
  ...
  if (value?.offline_epoch !== undefined && (!Number.isSafeInteger(value.offline_epoch) || value.offline_epoch < 0)) throw new Error('pwa_storage_unavailable');
